...
exports.handleResponse = (res) => {
  ...
  if (res && res.hasOwnProperty('alerts')) {
    ...
    console.log(`global-weather-notification-headlines: returning ${details.length} alert(s) meeting threshold out of ${res.alerts.length} total`)
  } else {
    console.log('global-weather-notification-headlines: No alerts in area')
  }
