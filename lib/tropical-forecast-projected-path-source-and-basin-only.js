 ...
 *
 * Tropical -Forecast - Projected Path (2) - The Tropical Forecast -
...
exports.handleResponse = (res) => {
  if (res && res.hasOwnProperty('index')) {
    console.log(`tropical-forecast-projected-path-source-and-basin-only: returned ${res.index.length} index(es)`)
    ...
    console.log('tropical-forecast-projected-path-source-and-basin-only: No index available')
  }
}
